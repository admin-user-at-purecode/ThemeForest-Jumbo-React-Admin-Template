...
import { chartYearlyData } from "../../mock_data/chartYearlyData";
import Div from "../Div/Div";
import { capitalizeFLetter } from "../../utils/constants/formatHelpers";

const gradientOffset = () => {
  const dataMax = Math.max(...chartYearlyData.map((i) => i.profit));
  const dataMin = Math.min(...chartYearlyData.map((i) => i.profit));
